...
export const Login = () => {
    ...
    //   });
    const predefinedEmail = 'parthasarthys93@gmail.com'; 
    const predefinedPassword = 'password123';

    const handleLogin = () => {
        // Verify the user's input with predefined values
        if (email === predefinedEmail && pass === predefinedPassword) {
            // Successful login
    ...
    <div className="auth-form-container">
        ...
        handleLogin();
            ...
            {loginError && <p className="error">Invalid email or password</p>}
                {email === predefinedEmail && pass === predefinedPassword ? (
                    <Link to="/Navcomponets">
